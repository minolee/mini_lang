...
public class Parser
{
    ...
    private void generateKeywords(File grammarFile) throws IOException, ParseException, ScannerException
    {
    ...
    private List<List<Keyword>> translateToSimpleForm(RegexTree<Keyword> keywords) throws ParseException
    {
        ...
        switch(keywords.op)
        {
            ...
            case REPEAT:
                 ...
                 *  C'-> CC' | e
                 */
                if(keywords.left.op != RegexOperation.NONE) throw new ParseException(ParseException.ExceptionType.ILLEGAL_GRAMMAR);
